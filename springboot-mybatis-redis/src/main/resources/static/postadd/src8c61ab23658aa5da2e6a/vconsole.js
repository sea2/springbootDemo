                            ...
                            key: "_initPlugin", value: function (e) {
                                ...
                                e.vConsole = this, e.trigger("init"), e.trigger("renderTab", (function (o) {
                                    ...
                                    if (o) for (var n = i.default.one(".vc-tool-last", t.$dom), a = function (t) {
                                        var a = o[t], l = i.default.render(u.default, {
                                            name: a.name || "Undefined",
                                            pluginID: e.id
                                        });
                            ...
                            key: "mockAjax", value: function () {
                                if (window.XMLHttpRequest) {
                                    ...
                                    e._open = t, e._send = o, window.XMLHttpRequest.prototype.open = function () {
                                        var o = this, n = [].slice.call(arguments), r = n[0], i = n[1],
                                            a = e.getUniqueID(), l = null;
                                        ...
                                        var t = this, n = [].slice.call(arguments), i = n[0],
