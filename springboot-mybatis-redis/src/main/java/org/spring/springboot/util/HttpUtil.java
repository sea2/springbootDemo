...
public class HttpUtil {
    ...
    public static String interceptorHttp(String urltype, String url, String dataJson, String httpModth, String httpGetQueryString) {
        ...
        } else if ("/v1.0/app/account/property".equals(urltype)) {
            strt = doHttpPost(url, dataJson);
        ...
        } else if ("/v1.0/app/system/loadConfigItem".equals(urltype)) {
            strt = "{\"code\":\"200\",\"result\":{\"100055\":\"http://192.168.3.240:9050/detail.html\"," + "\"10005\":\"http://192.168.3.240:9050/confirm_order.html\"}}";

        } else if ("/v1.0/app/product/appointmentInvestProList".equals(urltype)) {
        ...
        } else if ("/v1.0/app/product/appointmentInvestRecord".equals(urltype)) {
            String json45 = "";
            try {
                JSONObject resultJson2 = new JSONObject(dataJson);
        ...
        } else if ("/v1.0/app/".equals(urltype) || "/v1.0/app".equals(urltype)) {
            strt = "{\"code\":\"100\",\"list\":[{\"id\":\"1\",\"id1\":\"1\"},{\"id\":\"2\",\"id1\":\"2\"}],\"message\":\"请求无效，请检查请求拼接完整性\",\"sign\":\"xxxxxxxxx\"}";

        } else if ("/api/appIndex".equals(urltype)) {
        ...
        } else if ("/api/getRankLists".equals(urltype)) {
        ...
        } else if ("/api/getDownLists".equals(urltype)) {
        ...
        } else if ("/api/showGameInfo".equals(urltype)) {
        ...
        } else if ("/api/getStartAd".equals(urltype)) {
        ...
        } else if ("/api/getActivity".equals(urltype)) {
