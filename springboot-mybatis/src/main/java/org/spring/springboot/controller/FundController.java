...
import org.spring.springboot.util.BigDecimalUtils;
import org.spring.springboot.util.HttpUtil;
import org.spring.springboot.util.NumberUtils;
import org.spring.springboot.util.StringUtils;
...
public class FundController {
    ...
    public List<List<Object>> getGoToSame(HttpServletRequest request) {
        ...
        for (MyHasFundInfo mMyHasFundInfo : findAll) {
            List<TFundStockRelation> getList = new ArrayList<TFundStockRelation>();
    ...
    public List<FundCompareInfo> getCompareInfo(HttpServletRequest request) {
        List<FundCompareInfo> listFundCompareInfo = new ArrayList<FundCompareInfo>();
        String code = request.getParameter("code");
